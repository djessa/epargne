 ...
 */
final class Version20201205143811 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE depots (id INT AUTO_INCREMENT NOT NULL, fund_id INT NOT NULL, corporation_id INT DEFAULT NULL, created_at TIME NOT NULL, UNIQUE INDEX UNIQ_D99EA42725A38F89 (fund_id), INDEX IDX_D99EA427B2685369 (corporation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE depots_persons (depots_id INT NOT NULL, persons_id INT NOT NULL, INDEX IDX_35CAD087869F5222 (depots_id), INDEX IDX_35CAD087FE812AD (persons_id), PRIMARY KEY(depots_id, persons_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE retraits (id INT AUTO_INCREMENT NOT NULL, person_id INT NOT NULL, fund_id INT NOT NULL, created_at TIME NOT NULL, INDEX IDX_7BB2A03217BBB47 (person_id), UNIQUE INDEX UNIQ_7BB2A0325A38F89 (fund_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE depots ADD CONSTRAINT FK_D99EA427B2685369 FOREIGN KEY (corporation_id) REFERENCES corporations (id)');
        $this->addSql('ALTER TABLE depots_persons ADD CONSTRAINT FK_35CAD087869F5222 FOREIGN KEY (depots_id) REFERENCES depots (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE depots_persons ADD CONSTRAINT FK_35CAD087FE812AD FOREIGN KEY (persons_id) REFERENCES persons (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE depots_persons DROP FOREIGN KEY FK_35CAD087869F5222');
        ...
        $this->addSql('ALTER TABLE depots_persons DROP FOREIGN KEY FK_35CAD087FE812AD');
