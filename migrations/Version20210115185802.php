 ...
 */
final class Version20210115185802 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE depots (id INT AUTO_INCREMENT NOT NULL, fund_id INT NOT NULL, persons_id INT NOT NULL, corporations_id INT DEFAULT NULL, created_at DATETIME NOT NULL, end_date DATETIME DEFAULT NULL, is_retired TINYINT(1) DEFAULT NULL, UNIQUE INDEX UNIQ_D99EA42725A38F89 (fund_id), INDEX IDX_D99EA427FE812AD (persons_id), INDEX IDX_D99EA427D3AD0C8A (corporations_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, is_admin TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
